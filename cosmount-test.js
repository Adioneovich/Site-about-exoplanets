document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        ...
        },
        {
            ...
            answers: ["Exoplanet 55 Cancri e", "Kepler-90 g", "Moon", "Mars"],
            correct: 2
        },
        {
            question: "Why is the surface of Mars red?",
            answers: ["due to the presence of iron oxide in the soil", "Because of volcanic ash covering the planet.", "Due to the reflection of the Sun's light off its surface.", "Because of the high concentration of carbon dioxide in the atmosphere."],
            correct: 1
        }
    ];
    ...
    function showResult() {
        ...
        score.textContent = `Your result: ${userScore} из ${questions.length}`;
    }
